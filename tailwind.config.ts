  ...
  theme: {
    extend: {
      ...
      fontFamily: {
        ...
        body: ["'Shock Surgent'", "var(--font-shock-surgent)", "sans-serif"],
        mono: ["'Shock Surgent'", "monospace"],
        inkbleed: ["'Shock Surgent'", "sans-serif"],
        "inkbleed-serif": ["'Shock Surgent'", "sans-serif"],
